                ...
                <main>
                  <div className="bg-white p-6 rounded-lg shadow-md text-center md:text-left">
                    ...
                    <div className="text-gray-500 mb-4 flex align-middle justify-center md:justify-start">
                      <FaMapMarker className="inline text-lg mb-1 fill-orange-700" />
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                    ...
                    <h3 className="text-indigo-900 text-lg font-extrabold mb-2">
                      Salary
                    </h3>
                ...
                <aside>
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                    ...
                    <Link
                      ...
                      hover:bg-indigo-600 text-white text-center font-bold py-2
                      px-4 rounded-full w-full focus:outline-none
